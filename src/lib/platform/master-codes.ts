...
export const MASTER = {
  ...
  /** Customer billing entity — drives tax invoice name / tax ID fields. */
  ...
  auditActionType: {
    ...
    USER_PASSWORD_RESET_COMPLETE: "user.password_reset.complete",
    USER_PASSWORD_RESET_CANCEL: "user.password_reset.cancel",
    ...
    CUSTOM_ROLE_DELETE: "custom_role.delete",
