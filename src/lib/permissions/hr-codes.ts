...
export const HR_PERMISSION_LABELS: Record<HrPermission, string> = {
  ...
  [HR_PERMISSIONS.employeeRoleAssign]: "กำหนดบทบาทให้พนักงาน",
  [HR_PERMISSIONS.employeeRoleAssignPrivileged]: "กำหนดบทบาทสำคัญให้พนักงาน",
...
export const HR_PERMISSION_LABELS_EN: Record<HrPermission, string> = {
  ...
  [HR_PERMISSIONS.employeeRoleAssign]: "Assign employee roles",
  [HR_PERMISSIONS.employeeRoleAssignPrivileged]: "Assign privileged employee roles",
...
const RESOURCE_ACTION: Record<HrPermission, { resource: string; action: string }> =
  {
    ...
    [HR_PERMISSIONS.employeeRoleAssign]: { resource: "employee_role", action: "assign" },
    [HR_PERMISSIONS.employeeRoleAssignPrivileged]: { resource: "employee_role", action: "assign_privileged" },
