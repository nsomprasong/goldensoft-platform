...
- development อนุญาต `http://localhost:3000`
...
4. ตั้ง `AUTH_REAL_INVITE_TEST_EMAIL` เป็นอีเมลทดสอบเพียง 1 บัญชี
5. ตั้ง `AUTH_REAL_INVITE_CONFIRM=SEND_ONE_REAL_INVITE`
