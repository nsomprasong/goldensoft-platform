...
## Support-mode sidebar (org context)

เมื่อเลือกองค์กรใน Context Switcher:

| องค์กรที่เลือก | เมนูด้านข้าง |
|---|---|
| `GOLDENSOFT` (โกลเด้นซอฟต์) หรือยังไม่เลือกองค์กร | Platform Admin เต็มชุด (พนักงาน / ผลิตภัณฑ์ / ตั้งค่า ฯลฯ) |
| องค์กรลูกค้า (Super Admin หรือพอร์ตโฟลิโอของฝ่ายขาย) | เมนูซัพพอร์ตองค์กรนั้น: ภาพรวม · สาขา · ผู้ใช้ · เชิญ · บทบาท · สมัครใช้บริการ · เปิดแอปลูกค้า |
